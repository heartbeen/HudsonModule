...
public class ModuleProceedExtract extends ExtractDao {
    ...
    public Object extract() {
        try {
            ...
            sql.append(" CASE WHEN (MRR.ENDTIME - MRR.STARTTIME) IS NULL THEN 0 WHEN (MRR.ENDTIME - MRR.STARTTIME) = 0 THEN 100 ELSE ROUND((CASE WHEN SYSDATE > MRR.STARTTIME THEN SYSDATE - MRR.STARTTIME ELSE 0 END) / ");
            sql.append("  (MRR.ENDTIME - MRR.STARTTIME) * 100,1) END AS SPER ,ROUND((MRR.ENDTIME - SYSDATE) * 24, 1) AS DELAYHOUR ");
