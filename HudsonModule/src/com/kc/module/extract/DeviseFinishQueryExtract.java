...
public class DeviseFinishQueryExtract extends ExtractDao {
    ...
    public Object extract() {
        ...
        builder.append("SELECT DRR.ID,ML.MODULEBARCODE,ML.MODULECODE,ML.GUESTID,ML.GUESTCODE,FY.SHORTNAME,MPS.NAME AS RESUMESTATE,");
        ...
        builder.append("FROM DS_RESUME_RECORD DRR LEFT JOIN MODULELIST ML ON DRR.MODULEBARCODE = ML.MODULEBARCODE ");
        builder.append("LEFT JOIN FACTORY FY ON ML.GUESTID = FY.ID LEFT JOIN MD_PROCESS_STATE MPS ON DRR.STATEID = MPS.ID ");
