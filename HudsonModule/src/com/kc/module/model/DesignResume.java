...
public class DesignResume extends ModelFinal<DesignResume> {
    ...
    public List<DesignResume> getGroupDesignInfo(String groupid) {
        ...
        builder.append("SELECT DRR.ID,ML.MODULEBARCODE,ML.MODULECODE,ML.GUESTID,ML.GUESTCODE,FY.SHORTNAME, ML.MODULECLASS,ML.PRODUCTNAME,ML.WORKPRESSURE ");
        ...
        builder.append("FACTORY FY ON ML.GUESTID = FY.ID WHERE DR.GROUPID = ? ORDER BY ML.MODULECODE");
