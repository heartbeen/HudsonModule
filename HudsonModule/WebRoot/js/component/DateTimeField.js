 ...
 */
Ext.define('Project.component.TimePickerField', {
...
Ext.define('Project.component.DateTimePicker', {
    extend: 'Ext.picker.Date',
    //alias: 'widget.datetimepicker',
    todayText: '现在',
    timeLabel: '&nbsp;时间',
    requires: ['Project.component.TimePickerField'],
    initComponent: function() {
    ...
    onRender: function(container, position) {
        if(!this.timefield) {
            this.timefield = Ext.create('Project.component.TimePickerField', {
...
Ext.define('Project.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    //alias: 'widget.datetimefield',
    requires: ['Project.component.DateTimePicker'],
    initComponent: function() {
    ...
    createPicker: function() {
        ...
        return Ext.create('Project.component.DateTimePicker', {
              ownerCt: me.ownerCt,
