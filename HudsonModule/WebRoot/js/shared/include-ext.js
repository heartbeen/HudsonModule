...
(function() {
	...
	var scriptEls = document.getElementsByTagName('script'), path = scriptEls[scriptEls.length - 1].src, rtl = getQueryParam('rtl'),
	// console.log(rtl);
	theme = getQueryParam('theme') || 'classic', includeCSS = !hasOption('nocss', path), neptune = (theme === 'classic'), repoDevMode = getCookieValue('ExtRepoDevMode'), suffix = [], i = 3, neptunePath;
	...
	if (neptune) {
		...
		neptunePath = (repoDevMode ? path + '/..' : path) + '/ext4.2/packages/ext-theme-classic/build/ext-theme-classic'
				+ (repoDevMode ? '-dev' : '') + '.js';
