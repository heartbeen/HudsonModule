...
Ext.define('Ext.ux.desktop.TaskBar', {
	// This must be a toolbar. we rely on acquired toolbar classes and inherited
	// toolbar methods for our
	 ...
	 */
	startBtnText : Desktop.startBtnText,
...
Ext.define('Ext.ux.desktop.TrayClock', {
	...
	updateTime : function() {
		var date = new Date();
		var gap = date - StartTime;

		var me = this, time = Ext.Date.format(date, me.timeFormat), text = me.tpl.apply({
			time : time
		});
		if (me.lastText != text) {
			me.setText(text);
